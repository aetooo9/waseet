      ...
      <section id="main-content">
          <section class="wrapper">
              ...
              <div class="row">
                  ...
                  <h2><b>تعديل كلمة المرور</b></h2>
				  <form  action="changePassword.php" method="post">
				  <input type="hidden" name="UserId" value="<?php echo $_SESSION['UserId']; ?>">
                  <table class="table table-bordered">
				  <tr>
				  <td><b>كلمة المرور الجديدة</b></td>
				  <td><input type="password" name="Password" class="form-control" placeholder="كلمة المرور الجديدة" autofocus></td>
				  </tr>
				   <tr>
				  <td colspan="2">
